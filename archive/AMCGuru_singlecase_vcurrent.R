...
ggsave(paste("../../data/singlecase/", file_suffix, "patch1.pdf", sep = "") ,plot = patch1  + plot_annotation(tag_levels = 'A'), width = 8, height = 10 )
...
# TODO ----
# HGVSp=="ENSP00000003084.6:p.Ser1426Phe"
# HGVSp=="ENSP00000003084.6:p.Ser1426Phe"
# df |> filter(sample=="raw_ZH033") |> filter(SYMBOL == "CFTR") |> dplyr::select(HGVSp, sample, SYMBOL, gnomAD_AF)
# 
